...
public class AlbumsFlippedActivity extends FragmentActivity {
    ...
    public static ImageView nowPlayingFooterThumbnail;
    public static TextView nowPlayingFooterNowPlayingText;
    public static TextView nowPlayingFooterDetails;
	...
	public void onCreate(Bundle savedInstanceState) {
    	...
    	setContentView(R.layout.activity_albums_flipped);
	...
	private void inflateFragment() {
		...
		String headerImagePath = getIntent().getExtras().getString("HEADER_IMAGE_PATH");
		String artSource = getIntent().getExtras().getString("ART_SOURCE");
		this.albumName = albumName;
		
	    final Fragment albumsFlippedFragment = new AlbumsFlippedFragment();
	    Bundle albumBundle = new Bundle();
	    albumBundle.putString("ALBUM_NAME", albumName);
	    albumBundle.putString("ARTIST_NAME", artistName);
	    albumBundle.putString("HEADER_IMAGE_PATH", headerImagePath);
	    albumBundle.putString("ART_SOURCE", artSource);
	    albumsFlippedFragment.setArguments(albumBundle);
		
	    FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
	    transaction.replace(R.id.fragment_albums_flipped_placeholder, albumsFlippedFragment, "albumsFlippedFragment");
	    transaction.commit();
	...
	public void onPause() {
		...
		sharedPreferences.edit().putBoolean("ALBUMS_FLIPPED_ACTIVITY_VISIBLE", false).commit();
