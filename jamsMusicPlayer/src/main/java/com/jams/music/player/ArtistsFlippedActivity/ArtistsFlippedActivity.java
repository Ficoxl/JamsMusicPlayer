 ...
 * ArtistsFlipped fragment. Using a fragment within an activity 
 * gives us the flexibility to use custom transitions while 
 * retaining fragment support for tablet layouts.
 * 
 * @author Saravan Pantham
 ****************************************************************/
public class ArtistsFlippedActivity extends FragmentActivity {
    ...
    public String DARK_CARDS_THEME = "DARK_CARDS_THEME";
    public String LIGHT_CARDS_THEME = "LIGHT_CARDS_THEME";
	...
	public void onCreate(Bundle savedInstanceState) {
    	...
    	//Create a set of commonly used bitmaps.
	...
	private void inflateFragment() {
	    ...
	    final Fragment artistsFlippedFragment = new ArtistsFlippedFragment();
	    ...
	    artistsFlippedFragment.setArguments(artistBundle);

	    FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
	    transaction.replace(R.id.artists_flipped_layout, artistsFlippedFragment, "artistsFlippedFragment");
	    transaction.commit();
    ...
    public void onDestroy() {
    	super.onDestroy();
    	sharedPreferences.edit().putBoolean("ARTISTS_FLIPPED_ACTIVITY_VISIBLE", false).commit();
