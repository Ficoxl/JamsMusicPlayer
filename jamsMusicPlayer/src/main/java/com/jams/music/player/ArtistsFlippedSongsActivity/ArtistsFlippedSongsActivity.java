 ...
 ********************************************************************/
public class ArtistsFlippedSongsActivity extends FragmentActivity {
	...
	private void inflateFragment() {
		...
		String currentArtist = getIntent().getExtras().getString("ARTIST_NAME");
	    ...
	    final Fragment artistsFlippedSongsFragment = new ArtistsFlippedSongsFragment();
	    albumBundle = new Bundle();
	    albumBundle.putString("ALBUM_NAME", currentAlbum);
	    albumBundle.putString("ARTIST_NAME", currentArtist);
	...
	public void onPause() {
		super.onPause();
		sharedPreferences.edit().putBoolean("ARTISTS_FLIPPED_SONGS_ACTIVITY_VISIBLE", false).commit();
