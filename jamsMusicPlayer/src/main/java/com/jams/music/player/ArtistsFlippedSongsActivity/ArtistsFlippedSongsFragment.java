...
public class ArtistsFlippedSongsFragment extends Fragment {

	public static Context mContext;
	public static ArtistsFlippedSongsFragment fragment;
	...
	public static ArtistsFlippedSongsListViewAdapter songsListViewAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        songsListViewAdapter = new ArtistsFlippedSongsListViewAdapter(mContext, cursor);
        ...
        if (sharedPreferences.getString("SELECTED_THEME", "LIGHT_CARDS_THEME").equals("DARK_CARDS_THEME") ||
        	sharedPreferences.getString("SELECTED_THEME", "LIGHT_CARDS_THEME").equals("LIGHT_CARDS_THEME")) {
		...
		songsListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view, int index, long id) {
				...
				intent.putExtra("CALLING_FRAGMENT", "ARTISTS_FLIPPED_SONGS_FRAGMENT");
    ...
    public void playAllPressed() {
		...
		intent.putExtra("SELECTED_SONG_ARTIST", (String) songsListView.getChildAt(0).getTag(R.string.artist));
