 ...
 ********************************************************************/
public class GenresFlippedSongsActivity extends FragmentActivity {
    ...
    public String SELECTED_THEME = "SELECTED_THEME";
	...
	private void inflateFragment() {
		...
		String currentGenre = getIntent().getExtras().getString("GENRE_NAME");
		String dataURI = getIntent().getExtras().getString("HEADER_IMAGE_PATH");
		String artSource = getIntent().getExtras().getString("ART_SOURCE");
		this.albumName = currentAlbum;
		
		//Inflate the fragment within the activity layout.
	    final Fragment genresFlippedSongsFragment = new GenresFlippedSongsFragment();
	    albumBundle = new Bundle();
	    albumBundle.putString("ALBUM_NAME", currentAlbum);
	    albumBundle.putString("GENRE_NAME", currentGenre);
	    albumBundle.putString("HEADER_IMAGE_PATH", dataURI);
	    albumBundle.putString("ART_SOURCE", artSource);
	    genresFlippedSongsFragment.setArguments(albumBundle);

	    FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
	    transaction.replace(R.id.fragment_artists_flipped_songs_placeholder, genresFlippedSongsFragment, "genresFlippedSongsFragment");
	    transaction.commit();
	...
	public void onPause() {
		super.onPause();
		sharedPreferences.edit().putBoolean("GENRES_FLIPPED_SONGS_ACTIVITY_VISIBLE", false).commit();
	...
	public void onResume() {
		super.onResume();
		initQueueDrawer(true, true);
    	sharedPreferences.edit().putBoolean("GENRES_FLIPPED_SONGS_ACTIVITY_VISIBLE", true).commit();
